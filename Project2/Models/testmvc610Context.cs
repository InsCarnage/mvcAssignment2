...
{
    public partial class testmvc610Context : DbContext
    {
        public testmvc610Context()
        {
        }

        public testmvc610Context(DbContextOptions<testmvc610Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("server=den1.mssql7.gear.host;user id=testmvc610;password=My1Q9FsKi~?2;database=testmvc610");
            }
        }
